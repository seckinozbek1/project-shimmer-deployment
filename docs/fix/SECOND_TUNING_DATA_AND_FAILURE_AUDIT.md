# Second tuning data and failure audit
...
| Role | Raw rows | Substantive plans | Source document families | Conservative structural families | Canonical TRAIN | Canonical DEV |
|---|---|---|---|---|---|---|
| producer | 300 | 260 | 300 | 5 | 240 | 60 |
| auditor | 300 | 300 | 300 | 5 | 240 | 60 |
...
| DEV failure ID | Gap/contract taxonomy | Uncertainty counts |
|---|---|---|
| dev-catalogue-producer-extracted | wrong_referent=1 | TP/FP/FN 1/0/0 |
| dev-clinical-producer-extracted | wrong_referent=1 | TP/FP/FN 1/0/0 |
| dev-contracts-producer-extracted | wrong_referent=1 | TP/FP/FN 1/0/0 |
| dev-device-producer-extracted | wrong_referent=1 | TP/FP/FN 1/0/0 |
| dev-negotiation-producer-extracted | wrong_referent=1 | TP/FP/FN 1/0/0 |
| dev-nonsense-producer-extracted | wrong_referent=1 | TP/FP/FN 1/0/0 |
| dev-procurement-producer-extracted | wrong_referent=1 | TP/FP/FN 1/0/0 |
| dev-regulation-producer-extracted | wrong_referent=1 | TP/FP/FN 1/0/0 |
| v2-chronological_events-catalogue-primary | contract_error_unparsed=1 | TP/FP/FN 0/0/1 |
| v2-chronological_events-nonsense-primary | No gap error | TP/FP/FN 0/1/0 |
| v2-memo_sections-catalogue-primary | wrong_attribute=1; omission=1 | TP/FP/FN 1/0/0 |
| v2-memo_sections-clinical-primary | wrong_attribute=1 | TP/FP/FN 1/0/0 |
| v2-memo_sections-nonsense-primary | wrong_attribute=1 | TP/FP/FN 0/0/0 |
| v2-memo_sections-regulation-primary | No gap error | TP/FP/FN 0/1/0 |
| v2-question_answer-catalogue-conflicting | wrong_type_or_field=1; rendering_error=2 | TP/FP/FN 0/1/1 |
| v2-question_answer-catalogue-primary | omission=3 | TP/FP/FN 1/0/0 |
| v2-question_answer-clinical-conflicting | wrong_type_or_field=1; rendering_error=2 | TP/FP/FN 0/1/1 |
| v2-question_answer-clinical-primary | omission=2; wrong_type_or_state=1 | TP/FP/FN 1/0/0 |
| v2-question_answer-nonsense-conflicting | wrong_type_or_field=1; rendering_error=2 | TP/FP/FN 1/1/0 |
| v2-question_answer-nonsense-primary | omission=2 | TP/FP/FN 0/0/0 |
| v2-question_answer-regulation-conflicting | omission=2 | TP/FP/FN 1/0/0 |
| v2-question_answer-regulation-primary | omission=2; wrong_attribute=1 | TP/FP/FN 0/0/0 |
...
| Fold | Held-out group | P TRAIN | P DEV | A TRAIN | A DEV | Groups/rows | Auditor DEV classes |
|---|---|---|---|---|---|---|---|
| 0 | v2-structure-anchored | 240 | 60 | 240 | 60 | 80/20 | 12 each |
| 1 | v2-structure-sectioned | 240 | 60 | 240 | 60 | 80/20 | 12 each |
| 2 | v2-structure-discourse | 240 | 60 | 240 | 60 | 80/20 | 12 each |
| 3 | v2-structure-tabular | 240 | 60 | 240 | 60 | 80/20 | 12 each |
| 4 | v2-structure-enumerated | 240 | 60 | 240 | 60 | 80/20 | 12 each |
...
| Role | Component | Run-1 TRAIN | V2 canonical TRAIN |
|---|---|---|---|
| producer | claims | 5.82% | 3.47% |
| producer | gaps | 39.56% | 50.74% |
| producer | native_termination | 1.53% | 1.34% |
| producer | refs | 10.18% | 6.93% |
| producer | status | 1.53% | 1.77% |
| producer | structural_json | 15.40% | 18.83% |
| producer | uncertainty | 25.99% | 16.92% |
| auditor | native_termination | 2.95% | 2.40% |
| auditor | reason | 32.35% | 42.77% |
| auditor | refs | 17.15% | 16.83% |
| auditor | relation | 3.30% | 2.64% |
| auditor | status | 0.51% | 0.48% |
| auditor | structural_json | 43.73% | 34.86% |
...
Two passes of 240 TRAIN examples give **120 updates**, with DEV at **60 and 120**, identically in every fold and canonical run. Producer sequence ceiling / generation cap: **992 / 288**. Auditor: **1056 / 192**. Ceilings derive from tokenizer measurement with no truncation; generation caps include a 32-token margin and round to 32. Model/revision/quantization, adapter module counts and base-weight hashes remain those verified for run 1. No sweep or per-fold retuning exists.
