...
## CONV-D01 , conv-value-in-range [required]
...
## CONV-D02 , conv-calibration-signature [required]
...
## CONV-D03 , conv-calibration-authority [required]
...
## CONV-D04 , conv-fault-window [required]
...
## CONV-D05 , conv-service-interval [required]
...
## CONV-D06 , conv-neighbouring-entry [required]
...
## CONV-D07 , conv-grounding [required]
...
## CONV-D08 , conv-no-speculation [required]
