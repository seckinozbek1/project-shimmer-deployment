# Fresh producer V2 curation review
...
Outer keys: protocol="producer-coverage-amendment-v2", policy="producer-semantic-policy-v2", evidence_kind="training_label_curation_evidence", use="curation_only", packet_id, input_sha256 (copy exact packet binding), slot A/B/C, provenance="machine_agent_primary", reviewed_at ISO UTC, label, rationale.
