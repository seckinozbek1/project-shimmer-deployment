...
Packet: review-a09dd79b127f3f2a0fe2ddb3
...
```json
{
  ...
  "routed_rules": [],
  "extraction": "Revision history maintained by Test Lab: CLM-A registers Module Cedar proposed 20 signal cycles under REF-0001. The retained amendment, CLM-B, registers Module Elm amended 27 signal cycles under REF-0002. Both versions remain in the archive.  No effective period is specified. When does the amendment take effect?"
}
```
...
```json
{
  "packet_id": "review-a09dd79b127f3f2a0fe2ddb3",
  "input_sha256": "a09dd79b127f3f2a0fe2ddb3393493e5ff51b08ae774bcefe7e2f2541dd27a28",
