...
Packet: review-c9ba40e04dc27d0b92235870
...
```json
{
  ...
  "routed_rules": [],
  "extraction": "RECORD{kind=primary; text=\"CLM-A: survey plot 86 recorded 152 quadrats (REF-1001).\"}\nRECORD{kind=secondary; text=\"CLM-B: survey plot 86 retained 157 quadrats (REF-1002).\"}\nRECORD{kind=qualification; text=\"The date is absent. When was this recorded? The recorder is unnamed. Who recorded it?\"}"
}
```
...
```json
{
  "packet_id": "review-c9ba40e04dc27d0b92235870",
  "input_sha256": "c9ba40e04dc27d0b92235870a528566032eb76c77388477629cd5a761e26556b",
