...
Packet: review-de831e8a8952c63bdb0d589d
...
```json
{
  ...
  "routed_rules": [],
  "extraction": "Exception notice: the Test Lab inventory separates authorization from storage. CLM-A assigns Module Cedar authorized 20 signal cycles [REF-0001];  Neither classification implies the other. The storage location has not been supplied. Where are these objects located? The scope of the authorization is ambiguous."
}
```
...
```json
{
  "packet_id": "review-de831e8a8952c63bdb0d589d",
  "input_sha256": "de831e8a8952c63bdb0d589da73c6ead7cf3ea6c26681164ae956e406ef824fa",
