...
Packet: review-0e531d2b62d73338f6af9c6f
...
```json
{
  ...
  "routed_rules": [],
  "extraction": "Opening statement: CLM-A: survey plot 74 recorded 116 quadrats (REF-1001).\n\n| Supplement | Content |\n|---|---|\n| Detail | CLM-B: survey plot 74 retained 121 quadrats (REF-1002). |\n\nClosing qualification: The date is absent. When was this recorded? The recorder is unnamed. Who recorded it?"
}
```
...
```json
{
  ...
  "review": {
    "packet_id": "review-0e531d2b62d73338f6af9c6f",
    "input_sha256": "0e531d2b62d73338f6af9c6fe7a46883ccb73279e042291877eef0f2a6a1bfa0",
